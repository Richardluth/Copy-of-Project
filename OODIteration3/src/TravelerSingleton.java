//this class houses all the travelers and can display them. This is singleton, so only one can exist at a time.
public class TravelerSingleton
{
    private static TravelerSingleton instance;

    private TravelerSingleton()
    {
    }

    public static TravelerSingleton getInstance()
    {
        if(instance == null)
        {
            instance = new TravelerSingleton();
        }
        return instance;
    }
    ...
    Traveler trav18 = new Traveler("Samuel L. Jackson" , "7705917291");
    Traveler trav19 = new Traveler("Sean Connery" , "7707725976");
