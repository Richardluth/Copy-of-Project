...
public class Trip
{
    ...
    public void printTravelers() throws IOException, ParseException {
        try {
        ...
        {
            System.out.println("No travelers. Add travelers to continue.");
            Main.sc.SetStateFull(new AddTravelersToTripState());
        }
    }

    public void displayPackages() throws IOException, ParseException {
        try {
        ...
        {
            System.out.println("No packages. Add packages to continue.");
            Main.sc.SetStateFull(new AddPackagesToTripState());
        }
    }

    public void displayPayments() throws IOException, ParseException {
        try {
        ...
        System.out.println("No payments. Add payments to continue.");
